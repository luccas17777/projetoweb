		...
		<div class="row">
			<div class="card mb-3 col-12">
				<div class="card-body">
					...
					<p>
						<form method="post" action="controleDados/controllerCadastro.php" id="form" name="form">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="txtObservacao" id="txtObservacao" ></textarea>
							</div>
							<button type="submit" name="btnInserir" id="btnInserir" class="btn btn-primary">Cadastrar</button>
						</form>
					</p>
				</div>
			</div>
